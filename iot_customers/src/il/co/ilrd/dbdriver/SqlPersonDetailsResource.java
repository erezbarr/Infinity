...
public class SqlPersonDetailsResource implements SqlDBResource {
	private DatabaseManagement db;
	private final String TABLENAME = ResourceType.PERSON_DETAILS.toString();
	
	public SqlPersonDetailsResource(DatabaseManagement databaseManagement) {
	...
	public List<Map<String, Object>> get(KeyType key, Object value) {
		...
		switch (key) {
		case ID:
			keyToSearch = DriverUtils.PERSON_DETAILS_ID;
			break;
		case FIRST_NAME:
	...
	public int edit(Map<String, Object> resourceData) {
		...
		editList.add(DriverUtils.PERSON_DETAILS_ID);
		...
		return Integer.parseInt(resourceData.get(DriverUtils.PERSON_DETAILS_ID).toString());
	}
