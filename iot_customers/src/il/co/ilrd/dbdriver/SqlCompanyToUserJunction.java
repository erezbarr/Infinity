...
public class SqlCompanyToUserJunction implements SqlDBResource {
	private DatabaseManagement db;
	private final String TABLENAME = ResourceType.COMPANY_TO_USER.toString();

	
	public SqlCompanyToUserJunction(DatabaseManagement databaseManagement) {
